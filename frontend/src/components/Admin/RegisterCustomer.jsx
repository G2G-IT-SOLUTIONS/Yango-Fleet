...
//                     <span className="preview-label">Make:</span>
...
//   // ==========================================
//   const [preValidationStep, setPreValidationStep] = useState(true);
...
//       errors.general = 'Please enter either Phone Number or License Plate to check';
//     }
...
//       if (data.success) {
//         // Everything is available - proceed to registration
//         setPreValidationResult({ available: true });
//         setPreValidationStep(false);
//         // Pre-fill the phone number in driver data if provided
//         if (preValidationData.phone) {
//           setDriverData(prev => ({ ...prev, phone: preValidationData.phone }));
//         }
//         // Pre-fill the license plate in car data if provided
...
//   // Validate phone immediately while typing
//   if (name === 'phone') {
...
//                     type="text"
//                     name="license_plate"
//                     value={preValidationData.license_plate}
//                     onChange={handlePreValidationChange}
//                     placeholder="e.g., ETH-12345"
//                     className={preValidationErrors.license_plate ? 'error' : ''}
//                   />
...
//               {preValidationResult && !preValidationResult.available && (
//                 <div className="pre-validation-error">
...
//               {/* Phone - Text input (pre-filled from pre-validation) */}
//               <div className="form-group">
//                 <label>Phone *</label>
//                 <input
//                   type="tel"
...
//     // UPDATE THIS FUNCTION - Get the correct image URL
//     const getImageUrl = (imageName) => {
//         if (!imageName) return null;
//         if (imageName.startsWith('http')) return imageName;
        
//         // Your backend serves static files from /assets
//         // The image is in backend/src/assets/vehicle-types/
//         // So the URL should be: http://localhost:5000/assets/vehicle-types/filename
...
//                 <p className="vehicle-type-subtitle">Choose the type of vehicle you want to register</p>
//             </div>
...
//     license_plate_number: '',
//     comment: '',
//     vehicle_type_id: '' // ← Will be set from vehicle type selection
//   });
...
//     // Update carData with the selected vehicle_type_id
//     setCarData(prev => ({
//       ...prev,
...
//                 <div className="preview-grid">
//                   <div className="preview-item">
//                     <span className="preview-label">Vehicle Type:</span>
//                     <span className="preview-value">{selectedVehicleType?.name || 'Not selected'}</span>
//                   </div>
//                   <div className="preview-item">
//                     <span className="preview-label">Make:</span>
//                     <span className="preview-value">{carData.brand || '-'}</span>
...
//             <div className="vehicle-type-actions">
//                 <button
//                     className="btn-vehicle-type-skip"
//                     onClick={onSkip}
//                 >
//                     Skip for now
//                 </button>
...
//         // Pre-fill phone and license plate
//         if (preValidationData.phone) {
//           setDriverData(prev => ({ ...prev, phone: preValidationData.phone }));
//         }
//         if (preValidationData.license_plate) {
...
//  // RegisterCustomer.jsx - handleConfirmRegistration
...
//             // Check for binding duplicate error
...
//             } else if (errorData.error && errorData.error.includes('one_active_car_per_driver')) {
//                 errorMessage = 'This driver is already assigned to another car. Please select a different driver.';
//             }
            
//             // ✅ Show popup without crashing
//             alert(errorMessage);
...
//               {/* Blocked message - Working driver */}
...
//               {/* Update mode message - Fired/Not_working */}
...
//               {/* Create mode message - New driver */}
